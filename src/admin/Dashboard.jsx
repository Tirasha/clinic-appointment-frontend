...
const Dashboard = () => {
  const cards = [
    ...
    },
    {
      ...
      value: 100,
      sub: "",
      icon: <User size={36} strokeWidth={1.8} />,
      color: "from-[#C8F0FF] to-[#E3F9FF]",
    },
    {
      ...
      color: "from-[#E3ECFF] to-[#C8D9FF]",
    },
    {
      title: "Total Patients",
      value: 10,
      sub: "",
      icon: <BedDouble size={36} strokeWidth={1.8} />,
      color: "from-[#FFD6E3] to-[#FFE3EA]",
    },
  ];
